...
public class View extends JFrame {
    ...
    private int myNumberOfWorkspaces = 0;
    ...
    public void createNewWorkspace () {
        myNumberOfWorkspaces++;
        WorkspaceInView workspace =
                new WorkspaceInView(myModel,
                                    myCanvasBounds, myLanguage, myNumberOfWorkspaces);
        myTabbedPane.addTab("Workspace " + myNumberOfWorkspaces, workspace);
        myWorkspaces.add(workspace);
        myTabbedPane.setSelectedIndex(myNumberOfWorkspaces - 1);
